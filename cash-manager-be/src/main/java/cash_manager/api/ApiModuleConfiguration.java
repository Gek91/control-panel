...
import cash_manager.api.controllers.impl.CategoriesRestControllerImpl;
...
public class ApiModuleConfiguration {
    ...
    @Bean
    public CategoriesRestController categoriesRestController(CategoriesApplicationService categoriesApplicationService, MapperService mapperService) {
        return new CategoriesRestControllerImpl(categoriesApplicationService, mapperService);
    }
}
